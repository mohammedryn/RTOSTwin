...
### Task 1: Use the Root Canonical Protocol Files
**Prompt:** "Read the root-level canonical protocol files `docs/wire_format_spec.md` and `agent/core/wire_format.h`. Do not create or maintain a second VNV-local protocol header or protocol spec. All VNV code must consume the root canonical protocol truth."

**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`
**Output:** VNV implementation files aligned to the root canonical protocol files
**Gate:** No duplicate VNV-local protocol header or protocol spec remains under `vnv_final/`.
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`, `snapshot.h`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`, `framer.h`, `framer.c`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `decoder.py`
...
**Prompt:** "Create `bridge/mock_device.py` that generates valid RTOSTwin binary packets. It must follow the root canonical `agent/core/wire_format.h` protocol exactly. Support three modes: `--mode normal` (steady state 4-task system), `--mode leak` (heap decreases by 10 bytes/sec), `--mode saturated` (all tasks running, 95% CPU). Output to stdout at 10 Hz. Each packet must have valid CRC and incrementing snapshot-owned sequence numbers. Import and use the CRC function from decoder.py."
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`, `snapshot.h`, `profiler.h`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`, `framer.h`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`, `snapshot.h`, `encoder.h`, `framer.h`, `transport.h`, `profiler.h`
**Output:** `agent/main.c`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`, `decoder.py`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`, `state_manager.py`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `oom_analyzer.py`
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `CODING_RULES.md`, all `agent/core/*.h` files
...
**Context Files:** `../../docs/wire_format_spec.md`, `../../agent/core/wire_format.h`, `PRD.md`
...
```
Task 1 (root canonical protocol files)
  ├── Task 2 (snapshot.h)
